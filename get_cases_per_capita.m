function [quant_to_plot,info] = get_cases_per_capita(cases,population) 

D = size(cases,1); % number of days
quant_to_plot = cases./repmat(population,D,1)*1000; % cases/thousand people
...
info.cbar_label = 'Cases per Thousand People';
